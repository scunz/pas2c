...
#ifndef PASC_MODEL_TYPE_POINTER_OF_HPP
#define PASC_MODEL_TYPE_POINTER_OF_HPP
#pragma once
...
namespace Model
{
    ...
    class PASC_CODE_MODEL_API TypePointerOf : public TypeOf
    {
    public:
        typedef PtrT<TypePointerOf> Ptr;

    public:
        TypePointerOf(const Type::Ptr& t);
