...
#ifndef PASC_MODEL_STMT_REPEAT_HPP
#define PASC_MODEL_STMT_REPEAT_HPP
#pragma once
...
namespace Model {
    ...
    class PASC_CODE_MODEL_API StmtRepeat : public Stmt
    {
    public:
        typedef PtrT<StmtRepeat> Ptr;
    ...
    public:
        void setStmtList(StmtList::Ptr stmt);
